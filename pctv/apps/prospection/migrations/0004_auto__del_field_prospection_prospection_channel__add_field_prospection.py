...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('prospection_prospection', 'prospection_channel_id')

        # Adding field 'Prospection.financial_channel'
        db.add_column('prospection_prospection', 'financial_channel',
    ...
    def backwards(self, orm):
        ...
        db.add_column('prospection_prospection', 'prospection_channel',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['prospection.ProspectionChannel']),
                      keep_default=False)

        # Deleting field 'Prospection.financial_channel'
        db.delete_column('prospection_prospection', 'financial_channel')
    ...
    models = {
        'account.profile': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'default': '2L', 'to': "orm['auth.User']", 'unique': 'True'})
        },
        'auth.group': {
