...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Prospection.total_income'
        db.alter_column('prospection_prospection', 'total_income', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Prospection.total_income'
        db.alter_column('prospection_prospection', 'total_income', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2))
