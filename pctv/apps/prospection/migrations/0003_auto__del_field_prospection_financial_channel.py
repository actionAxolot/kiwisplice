...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('prospection_prospection', 'financial_channel_id')


    def backwards(self, orm):
        # Adding field 'Prospection.financial_channel'
        db.add_column('prospection_prospection', 'financial_channel',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['finance.FinancialChannelProspection']),
                      keep_default=False)
