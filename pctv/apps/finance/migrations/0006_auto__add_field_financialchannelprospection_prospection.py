...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FinancialChannelProspection.prospection'
        db.add_column('finance_financialchannelprospection', 'prospection',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['prospection.Prospection']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FinancialChannelProspection.prospection'
        db.delete_column('finance_financialchannelprospection', 'prospection_id')
