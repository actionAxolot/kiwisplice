...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FinancialChannelClient.client'
        db.add_column('finance_financialchannelclient', 'client',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['client.Client']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FinancialChannelClient.client'
        db.delete_column('finance_financialchannelclient', 'client_id')
