...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FinancialChannelProspection'
        db.create_table('finance_financialchannelprospection', (
            ...
            ('amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2, blank=True)),
        ))
        db.send_create_signal('finance', ['FinancialChannelProspection'])


    def backwards(self, orm):
        # Deleting model 'FinancialChannelProspection'
        db.delete_table('finance_financialchannelprospection')
