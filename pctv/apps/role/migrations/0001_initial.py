...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field user on 'Role'
        db.create_table('role_role_user', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('role', models.ForeignKey(orm['role.role'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('role_role_user', ['role_id', 'user_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field user on 'Role'
        db.delete_table('role_role_user')
