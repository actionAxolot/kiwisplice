...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Condo'
        db.create_table('inventory_condo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('inventory', ['Condo'])

        # Adding field 'Inventory.condo'
        db.add_column('inventory_inventory', 'condo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['inventory.Condo']),
                      keep_default=False)


        # Changing field 'Inventory.cuv'
        db.alter_column('inventory_inventory', 'cuv', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):
        # Deleting model 'Condo'
        db.delete_table('inventory_condo')

        # Deleting field 'Inventory.condo'
        db.delete_column('inventory_inventory', 'condo_id')


        # Changing field 'Inventory.cuv'
        db.alter_column('inventory_inventory', 'cuv', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
