...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Inventory.x'
        db.add_column('inventory_inventory', 'x',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=6, blank=True),
                      keep_default=False)

        # Adding field 'Inventory.y'
        db.add_column('inventory_inventory', 'y',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=6, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Inventory.x'
        db.delete_column('inventory_inventory', 'x')

        # Deleting field 'Inventory.y'
        db.delete_column('inventory_inventory', 'y')
