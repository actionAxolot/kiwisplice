...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Inventory.build_end_date'
        db.add_column('inventory_inventory', 'build_end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Inventory.build_end_date'
        db.delete_column('inventory_inventory', 'build_end_date')
