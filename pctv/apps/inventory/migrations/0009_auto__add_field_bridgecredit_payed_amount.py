...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BridgeCredit.payed_amount'
        db.add_column('inventory_bridgecredit', 'payed_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=20, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BridgeCredit.payed_amount'
        db.delete_column('inventory_bridgecredit', 'payed_amount')
    ...
    models = {
        ...
        'inventory.inventory': {
            ...
            'build_end_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
