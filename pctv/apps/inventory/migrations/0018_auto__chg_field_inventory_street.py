...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Inventory.street'
        db.alter_column('inventory_inventory', 'street', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Inventory.street'
        db.alter_column('inventory_inventory', 'street', self.gf('django.db.models.fields.CharField')(default='Sin calle', max_length=50))
