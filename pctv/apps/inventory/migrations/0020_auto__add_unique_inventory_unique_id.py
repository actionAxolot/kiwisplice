...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Inventory', fields ['unique_id']
        db.create_unique('inventory_inventory', ['unique_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Inventory', fields ['unique_id']
        db.delete_unique('inventory_inventory', ['unique_id'])
