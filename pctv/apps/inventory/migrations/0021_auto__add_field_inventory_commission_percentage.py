...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Inventory.commission_percentage'
        db.add_column('inventory_inventory', 'commission_percentage',
                      self.gf('django.db.models.fields.DecimalField')(default=30, max_digits=5, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Inventory.commission_percentage'
        db.delete_column('inventory_inventory', 'commission_percentage')
    ...
    models = {
        ...
        'inventory.inventory': {
            ...
            'unique_id': ('django.db.models.fields.CharField', [], {'max_length': '50', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
