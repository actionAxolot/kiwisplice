...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Prototype.commission_percentage'
        db.add_column('inventory_prototype', 'commission_percentage',
                      self.gf('django.db.models.fields.DecimalField')(default=5.0, max_digits=5, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Prototype.commission_percentage'
        db.delete_column('inventory_prototype', 'commission_percentage')
