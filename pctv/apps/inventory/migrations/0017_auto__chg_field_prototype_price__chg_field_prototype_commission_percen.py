...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Prototype.price'
        db.alter_column('inventory_prototype', 'price', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Prototype.commission_percentage'
        db.alter_column('inventory_prototype', 'commission_percentage', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Prototype.price'
        db.alter_column('inventory_prototype', 'price', self.gf('django.db.models.fields.CharField')(default=0, max_length=50))

        # Changing field 'Prototype.commission_percentage'
        db.alter_column('inventory_prototype', 'commission_percentage', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=2))
