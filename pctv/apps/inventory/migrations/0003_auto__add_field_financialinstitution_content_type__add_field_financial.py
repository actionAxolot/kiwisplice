...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FinancialInstitution.content_type'
        db.add_column('inventory_financialinstitution', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'FinancialInstitution.object_id'
        db.add_column('inventory_financialinstitution', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FinancialInstitution.content_type'
        db.delete_column('inventory_financialinstitution', 'content_type_id')

        # Deleting field 'FinancialInstitution.object_id'
        db.delete_column('inventory_financialinstitution', 'object_id')
