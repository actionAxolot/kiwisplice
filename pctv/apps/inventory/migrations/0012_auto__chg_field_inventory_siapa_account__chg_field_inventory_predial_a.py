...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Inventory.siapa_account'
        db.alter_column('inventory_inventory', 'siapa_account', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Inventory.predial_account'
        db.alter_column('inventory_inventory', 'predial_account', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Inventory.clg_emission_date'
        db.alter_column('inventory_inventory', 'clg_emission_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Inventory.clg_folium'
        db.alter_column('inventory_inventory', 'clg_folium', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Inventory.siapa_account'
        db.alter_column('inventory_inventory', 'siapa_account', self.gf('django.db.models.fields.CharField')(default=0, max_length=50))

        # Changing field 'Inventory.predial_account'
        db.alter_column('inventory_inventory', 'predial_account', self.gf('django.db.models.fields.CharField')(default=0, max_length=50))

        # Changing field 'Inventory.clg_emission_date'
        db.alter_column('inventory_inventory', 'clg_emission_date', self.gf('django.db.models.fields.DateField')(default=0))

        # Changing field 'Inventory.clg_folium'
        db.alter_column('inventory_inventory', 'clg_folium', self.gf('django.db.models.fields.CharField')(default=0, max_length=50))
