...
from apps.inventory.views import (InventoryView, InventoryCreateView, 
	InventoryDeleteView, InventorySectionView, InventoryDPFView, 
	InventorySectionCreateView, InventorySectionDeleteView, InventoryPrototypeView, 
	InventoryPrototypeCreateView, InventoryPrototypeDeleteView, InventoryBridgeCreditView,
