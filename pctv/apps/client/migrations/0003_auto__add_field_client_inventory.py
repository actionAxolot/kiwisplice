...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Client.inventory'
        db.add_column('client_client', 'inventory',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Inventory'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Client.inventory'
        db.delete_column('client_client', 'inventory_id')
    ...
    models = {
        ...
        'client.client': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'no client'", 'max_length': '50'})
        },
        'comment.comment': {
