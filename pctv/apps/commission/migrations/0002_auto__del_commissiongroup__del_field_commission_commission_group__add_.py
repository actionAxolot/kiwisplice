...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Commission.commission_group'
        db.delete_column('commission_commission', 'commission_group_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Commission.commission_group'
        db.add_column('commission_commission', 'commission_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['commission.CommissionGroup']),
                      keep_default=False)
